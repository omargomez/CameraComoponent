...
-(void) willRotateToInterfaceOrientation:(UIInterfaceOrientation)toInterfaceOrientation duration:(NSTimeInterval)duration
{
    ...
    NSLog(@"willRotateToInterfaceOrientation, %d", (int) toInterfaceOrientation);
}

- (void) didRotateFromInterfaceOrientation:(UIInterfaceOrientation)fromInterfaceOrientation
{
    NSLog(@"didRotateFromInterfaceOrientation, %d", (int) fromInterfaceOrientation);
    [self.view layoutIfNeeded];
    [helper layoutPreviewInView:imageView];
}
...
{	
    ...
    LeadsController *leadCntrllr = [[LeadsController alloc] initWithNibName:@"LeadsController" bundle:nil];
    
    window.rootViewController = leadCntrllr;
